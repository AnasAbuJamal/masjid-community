  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button className="bg-emerald-600 hover:bg-emerald-700" onClick={openCreate}><Plus className="h-4 w-4 mr-2" />New Job</Button>
      </div>
      ...
      <Dialog open={jobDialog} onOpenChange={setJobDialog}>
        <DialogContent className="max-w-2xl max-h-[85vh] overflow-y-auto">
          ...
          <DialogFooter><Button variant="outline" onClick={() => setJobDialog(false)}>Cancel</Button><Button className="bg-emerald-600 hover:bg-emerald-700" onClick={handleSave} disabled={saving}>{saving ? "Saving..." : editing ? "Update" : "Create"}</Button></DialogFooter>
        </DialogContent>
      </Dialog>
